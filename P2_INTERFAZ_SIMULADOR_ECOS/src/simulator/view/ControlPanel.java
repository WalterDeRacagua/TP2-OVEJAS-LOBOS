...
class ControlPanel extends JPanel {
	...
	private ChangeStrategysDialog _changeStrategysDialog;
	private TablaDialog _tableDialog;
	...
	private JButton _strategysButton;
	...
	private JButton _specialButton;
...
// Special Button
		this._specialButton = new JButton();
		this._specialButton.setToolTipText("Special");
		this._specialButton.setIcon(new ImageIcon("resources/icons/special.png"));
		this._specialButton.addActionListener(new ActionListener() {
		...
		this._toolaBar.add(this._specialButton);
// Strategy button
		this._strategysButton = new JButton();
		this._strategysButton.setToolTipText("Change Strategys");
		this._strategysButton.setIcon(new ImageIcon("resources/icons/strategys.png"));
		this._strategysButton.addActionListener((e) -> changeStrategys());
		this._toolaBar.add(this._strategysButton);
...
// Quit Button
	...
	private void changeStrategys() {
		_changeStrategysDialog = new ChangeStrategysDialog(this._ctrl);
		_changeStrategysDialog.open(SwingUtilities.getWindowAncestor(this));
	}

	private void specialButton() {

		this._tableDialog = new TablaDialog(this._ctrl);
		this._tableDialog.open(SwingUtilities.getWindowAncestor(this));
	}
}
